...
<SongComponent src="/ost/intro.mp3" autoplay={true} pause={openingPause} volume={getVolume()}></SongComponent>
<Content id="scenario" style="background-color: #161616;">
    <h1 lang="en">Really Inaccessible</h1>
    <br/>
    <br/>
    <h2>Contexte</h2>
    <p style="font-size: 1.6rem">Bienvenue dans "Rea11y Inaccessible", un escape game inédit dans lequel vous serez confronté aux défis de
        l'accessibilité. </p>
