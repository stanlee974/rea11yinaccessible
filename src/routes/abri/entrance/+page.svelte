        ...
        <Row>
            ...
            <Column>
                ...
                <p>Un vieux panneau, à moitié effacé par le temps, porte l'inscription : "Refuge Alpha - Accès
                    Réservé au Personnel Autorisé". Tu t'approches de l'entrée avec unn mélange de curiosité et
                    d'appréhension.
                </p>
            </Column>
        </Row>
...
<script lang="ts">
  ...
  import { Button, Column, Grid, ImageLoader, Row, ToastNotification } from "carbon-components-svelte";
