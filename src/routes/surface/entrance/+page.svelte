...
<Content>
    ...
    <br/>
    <Modal size="lg" passiveModal bind:open={showTransitionModal} modalHeading=""
        ...
        <div style="display: flex; flex-direction: row">
            <Grid>
                <Row>
                    ...
                    <Column><p >En réussissant à résoudre les énigmes malgré les hallucinations
                        perturbantes, tu as su montrer ta capacité à rester concentré et déterminé.</p>
                        <p>Une dernière hallucination te montre un journal mentionnant un
                            laboratoire secondaire situé à la surface, dans une ancienne zone industrielle.</p>
                        <p>Tu empruntes un dernier escalier et te voilà bientôt à la
                            surface.</p>
                    </Column>
                </Row>
            </Grid>
    ...
    <Modal size="lg" passiveModal bind:open={showEntrance} modalHeading=""
    ...
    <div style="display: flex; flex-direction: column; margin-top: 2rem; align-items: center; justify-content: center;">
        <Modal bind:open={showTrialModal} passiveModal modalHeading="Tableau de contrôle" on:open on:close>
...
<script lang="ts">
  ...
  const holdingMouseTremors = () => {
    setTimeout(() => {
      mouseX = mouseX + sampleInt(10)
      mouseY = mouseY + sampleInt(10)
      holdingMouseTremors();
    }, 20)
  }
