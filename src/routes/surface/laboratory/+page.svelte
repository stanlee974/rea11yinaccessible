...
<Content>
    <Typewriter mode="scramble">
        <div class="container">
            ...
            <h2 class="flux">Le laboratoire</h2>
        </div>
    </Typewriter>
    <br/>
        ...
        <div style="display: flex; flex-direction: row">
            <Grid>
                <Row>
                    ...
                    <Column><p>Tu arrives correctement à activer le bouton et un mécanisme
                        ...
                        <p>Tu avances prudemment et ressent immédiatement un froid glacial
