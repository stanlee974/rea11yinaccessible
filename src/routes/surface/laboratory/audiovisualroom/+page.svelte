        ...
        <div style="display: flex; flex-direction: row">
            <Grid>
                <Row>
                    ...
                    <Column><p>Une petite trappe s'ouvre et tu y glisses ta main. Rien à
                        l'intérieur... </p>
                        <p>Tu continues donc, ton exploration du laboratoire secondaire. Des
