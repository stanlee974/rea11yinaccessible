...
<Content>
        ...
        <div style="display: flex; flex-direction: row">
            <Grid>
                <Row>
                    ...
                    <Column><p>La borne électronique émet un bip satisfaisant alors qu'une carte magnétique s'éjecte de
                        son compartiment.</p>
                        <p>Tu la saisis rapidement, mais ton triomphe est de courte durée. Des bruits de pas lourds et
                        ...
                        <p>Sans perdre un instant, tu rebrousses chemin, courant silencieusement mais précipitamment
    ...
    <TypewriterComponent disabled={showScenario}
                         parentDoneAction={() => setTimeout(() => showContinueButton = true, 2000)}>
            ...
            <Row>
                <Column>
                    <div class="glitch">
                        ...
                        <p>Les traqueurs se rapprochent, leurs pas devenant de plus en plus distincts.</p>
                        <p>La porte s'ouvre lentement avec
    ...
    <br/>
    <TypewriterComponent disabled={disableGoal} parentDoneAction={() => setTimeout(() => showForm = true, 2000)}>
